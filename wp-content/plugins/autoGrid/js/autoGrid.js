...
// ========================= Grid ===============================
  ...
  $.fn.autoGridGallery = function( options ) {
    ...
    var db = function($this){
        ...
        var directoryFixed = $directory.split("../").join("-back-");
        /* ************ BRING INFORMATION THROUGH JSON ********* */
        $.getJSON($path+"reader.php?directory="+directoryFixed+'&categoriesOrder='+ops.categoriesOrder+'&imagesOrder='+ops.imagesOrder,function(data){ 
            rsJSON = data;
        ...
        var loadImage = function(image, firstTime){
                ...
                if(ops.pinterest != undefined){//Pintrest
